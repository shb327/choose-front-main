...
public class EditCommunityAdapter extends RecyclerView.Adapter<EditCommunityAdapter.ViewHolder>{
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater
                ...
                .inflate(R.layout.settings_community_row, viewGroup, false);
        return new ViewHolder(view, listener);
    }

    public EditCommunityAdapter(List<CommunityDTO> localDataSet, ClickListener listener) {
        this.localDataSet = localDataSet;
        this.listener = listener;
    }

    public EditCommunityAdapter(ClickListener listener) {
        this.listener = listener;
    }
