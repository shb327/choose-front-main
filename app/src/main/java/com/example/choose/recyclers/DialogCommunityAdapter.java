...
public class DialogCommunityAdapter extends RecyclerView.Adapter<DialogCommunityAdapter.ViewHolder>{
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater
                ...
                .inflate(R.layout.dialog_row, viewGroup, false);
        return new ViewHolder(view, listener);
    }

    public DialogCommunityAdapter(List<CommunityDTO> localDataSet, ClickListener listener) {
        this.localDataSet = localDataSet;
        this.listener = listener;
    }

    public DialogCommunityAdapter(ClickListener listener) {
        this.listener = listener;
    }
