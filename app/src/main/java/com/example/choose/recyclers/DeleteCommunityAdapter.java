...
public class DeleteCommunityAdapter extends RecyclerView.Adapter<DeleteCommunityAdapter.ViewHolder>{
    ...
    public DeleteCommunityAdapter(List<CommunityDTO> localDataSet, ClickListener listener) {
        this.localDataSet = localDataSet;
        this.listener = listener;
    }

    public DeleteCommunityAdapter(ClickListener listener) {
        this.listener = listener;
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener {
        ...
        public void onClick(View v) {
            if (v.getId() == button.getId()) {
                ...
                communityController
                        .deleteCommunity(communityDTO.getId().intValue())
                        .enqueue(new Callback<Void>() {
                            @Override
                            public void onResponse(Call<Void> call, Response<Void> response) {
                                removeAt(getAdapterPosition());
                                Toast.makeText(v.getContext(), "Community: " + communityDTO.getName() + ", is deleted!", Toast.LENGTH_SHORT).show();
