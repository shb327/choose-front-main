...
public class DiscoverCommunityAdapter extends RecyclerView.Adapter<DiscoverCommunityAdapter.ViewHolder>{
    ...
    public DiscoverCommunityAdapter(List<CommunityDTO> localDataSet, ClickListener listener) {
        this.localDataSet = localDataSet;
        this.listener = listener;
    }

    public DiscoverCommunityAdapter(ClickListener listener) {
        this.listener = listener;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater
                ...
                .inflate(R.layout.discover_community_row, viewGroup, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener {
        ...
        public void onClick(View v) {
            if (v.getId() == button.getId()) {
                ...
                communityController
                        .joinCommunity(communityDTO.getId().intValue())
                        .enqueue(new Callback<Void>() {
                            @Override
                            public void onResponse(Call<Void> call, Response<Void> response) {
                                removeAt(getAdapterPosition());
                                Toast.makeText(v.getContext(), "Community: " + communityDTO.getName() + ", is followed!", Toast.LENGTH_SHORT).show();
                                Log.i("Follow", response.raw().request().headers().toString());
                            }

                            @Override
                            public void onFailure(Call<Void> call, Throwable t) {
                                Log.e("Follow Error", t.getMessage(), t);
                            }
                        });
            } else {
